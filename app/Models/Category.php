...
class Category extends Model
{
    ...
    {
        return $this->where('status', CategoryStatus::ACTIVE->value);
    }

    public function scopeInactive($query)
    {
        return $this->where('status', CategoryStatus::INACTIVE->value);
    }

    public function scopeDraft($query)
    {
        return $this->where('status', CategoryStatus::DRAFT->value);
    }
    ...
    {
        return $this->where('categorizable_type', CategoryType::PRODUCT->value)->whereNull('parent_id');    
    }

    public function scopeJobs()
    {
        return $this->where('categorizable_type', CategoryType::JOB->value)->whereNull('parent_id');    
    }
