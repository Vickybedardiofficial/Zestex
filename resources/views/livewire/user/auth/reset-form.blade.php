<div>
    <form method="POST" wire:submit.prevent="submitForm">
        <div class="auth-form-shell">
            ...
            <div class="block">
                <div class="border border-bord-pr gap-2.5 px-3 rounded-xl flex h-12 items-center overflow-hidden bg-fill-fv/40">
                ...
                <div class="mb-6">
                    <a href="{{ route('user.auth.index') }}" class="auth-link">
