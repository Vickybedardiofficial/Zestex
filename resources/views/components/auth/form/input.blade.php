    ...
    <div class="block relative">
        ...
        @if ($isPassword)
            <span class="absolute right-0 top-0 bottom-0 inline-flex-center px-4">
                <button x-on:click="inputType = (inputType == 'password' ? 'text' : 'password')" class="size-6 cursor-pointer text-lab-sc outline-hidden hover:text-lab-pr2 transition" type="button">
