...
<script>
    ...
    export default defineComponent({
        setup: function() {
            ...
            onMounted(async () => {
                await ZESTEXAPI().userSettings().getFrom('notifications/push/settings').then((response) => {
            ...
            const submitForm = async () => {
                if (state.isSubmitting === false) {
                    ...
                    await ZESTEXAPI().userSettings().with(formData.value).putTo('notification/push/update').then((response) => {
