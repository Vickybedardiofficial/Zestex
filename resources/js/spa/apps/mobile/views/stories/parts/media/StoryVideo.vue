    ...
    export default defineComponent({
        ...
        setup: function(props) {
            ...
            onMounted(() => {
                ...
                ZESTEXEventBus.on('story:unmute', unmuteVideo);

                ZESTEXEventBus.on('story:mute', muteVideo);
            });

            onBeforeUnmount(() => {
                ZESTEXEventBus.off('story:unmute', unmuteVideo);
                ZESTEXEventBus.off('story:mute', muteVideo);
            });
