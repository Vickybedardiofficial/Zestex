    ...
    export default defineComponent({
        ...
        setup: function(props, context) {
            ...
            onMounted(() => {
                ...
                ZESTEXEventBus.on('story:play', playStory);
                ZESTEXEventBus.on('story:pause', pauseStory);
            ...
            onUnmounted(() => {
                ZESTEXEventBus.off('story:play', playStory);
                ZESTEXEventBus.off('story:pause', pauseStory);
            });
