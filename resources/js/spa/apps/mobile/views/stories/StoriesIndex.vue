    ...
    export default defineComponent({
        ...
        setup: function(props) {
            ...
            onMounted(async () => {
                ...
                ZESTEXEventBus.on('story:delete', handleStoryDelete);
				ZESTEXEventBus.on('story:leave', closeStories);
                storiesSwiper.initialize();
            });

            onUnmounted(() => {
                ZESTEXEventBus.off('story:delete', handleStoryDelete);
				ZESTEXEventBus.off('story:leave', closeStories);
            });
