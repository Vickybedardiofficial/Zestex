<template>
    <div class="markdown-text">
        <div ref="publicationTextHolder" v-bind:class="[!state.textExpanded ? 'line-clamp-[12]' : '']" class="leading-5 text-lab-pr2 text-par-m font-normal publication-text break-words" v-html="markdownRenderer()"></div>
...
<script>
    ...
    export default defineComponent({
        ...
        setup: function(props) {
            ...
            MarkdownIT.use(MarkdownHashtagPlugin);
