<template>
	...
	v-bind:buttonRole="isApproved ? 'marginal' : 'default'"></PrimaryPillButton>
</template>

<script>
    import { defineComponent, computed, ref, popScopeId } from 'vue';
	import { ZESTEXFollow } from '@/kernel/services/follows/index.js';
        ...
        setup: function(props) {
			...
			return {
				...
				handleFollowAccept: () => {
					...
					ZESTEXFollow().user(props.followableId).accept();
