...
<script>
    ...
    export default defineComponent({
        setup: function() {
            ...
            onMounted(async () => {
                await ZESTEXAPI().userSettings().getFrom('personal/city').then((response) => {
            ...
            return {
                ...
                submitForm: async () => {
                    if (state.isSubmitting === false) {
                        ...
                        await ZESTEXAPI().userSettings().with(formData.value).putTo('personal/city/update').then((response) => {
