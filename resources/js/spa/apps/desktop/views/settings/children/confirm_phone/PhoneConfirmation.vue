...
<script>
    ...
    export default defineComponent({
        setup: function() {
            ...
            onMounted(async () => {
                await ZESTEXAPI().userSettings().getFrom('phone/check').then((response) => {
            ...
            return {
                ...
                resendCode: async () => {
                    if (state.isSubmitting === false) {
                        ...
                        await ZESTEXAPI().userSettings().sendTo('phone/update/resend').then((response) => {
                ...
                confirmCode: async () => {
                    if (state.isSubmitting === false) {
                        ...
                        await ZESTEXAPI().userSettings().with(formData).sendTo('phone/update/confirm').then((response) => {
                            toastSuccess(__t('toast.phone_updated'));
