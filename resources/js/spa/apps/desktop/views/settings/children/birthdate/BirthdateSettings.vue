...
<script>
    ...
    export default defineComponent({
        setup: function() {
            ...
            onMounted(async () => {
                await ZESTEXAPI().userSettings().getFrom('personal/birthdate').then((response) => {
            ...
            return {
                ...
                submitForm: async() => {
                    if (state.isSubmitting === false) {
                        ...
                        await ZESTEXAPI().userSettings().with(formData.value).putTo('personal/birthdate/update').then((response) => {
