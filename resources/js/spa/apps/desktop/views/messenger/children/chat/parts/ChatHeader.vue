<template>
	<div class="h-16 flex justify-between items-center px-6">
		...
		<div class="inline-flex gap-2.5">
			<PrimaryIconButton iconName="search-lg" v-bind:disabled="true"></PrimaryIconButton>
			<template v-if="chatData.is_group">
			...
			<template v-else>
				<PrimaryIconButton v-bind:disabled="true" iconName="phone" iconType="line"></PrimaryIconButton>
