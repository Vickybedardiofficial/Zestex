...
<script>
    ...
    export default defineComponent({
        ...
        setup: function(props) {
            ...
            onMounted(() => {
                if(window.ZESTEXBRD) {
                    ZESTEXBRD.private(BRD.getChannel('AUTH_USER', [userId])).listen(BRD.getEvent('TIMELINE_MEDIA_PROCESSED'), function (event) {
            ...
            onUnmounted(() => {
                if(window.ZESTEXBRD) {
                    ZESTEXBRD.private(BRD.getChannel('AUTH_USER', [userId])).stopListening(BRD.getEvent('TIMELINE_MEDIA_PROCESSED'));
                }
            });
