...
const useInboxStore = defineStore('chats_inbox', {
    ...
    actions: {
        fetchChatRequests: async function() {
            await ZESTEXAPI().messenger().getFrom('chats/requests').then((response) => {
        ...
        fetchChatRequestsCount: async function() {
            await ZESTEXAPI().messenger().getFrom('chats/requests/count').then((response) => {
        ...
        fetchChatsHistory: async function() {
            ...
            await ZESTEXAPI().messenger().getFrom('chats').then(function(response) {
        ...
        fetchChatsArchive: async function() {
            await ZESTEXAPI().messenger().getFrom('archive').then((response) => {
        ...
        fetchUnreadCount: function() {
			ZESTEXAPI().messenger().getFrom('unread/count').then((response) => {
