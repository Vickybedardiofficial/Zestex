...
return [
    ...
    'env_edit_notice' => [
		'title' => 'How to edit?',
		'line_one' => 'These settings are managed from the <code>.env</code> file (located in the root of your Zestex installation) and cannot be changed from the admin panel.',
	...
	'round_robin_notice' => [
		...
		'line_one' => 'Zestex features a round-robin storage system that supports both S3 and FTP as backend options.',
		...
		'line_three' => 'Once configured, Zestex will automatically distribute files across the available storage accounts in a round-robin fashion, helping you balance storage usage seamlessly.'
	],
	'laravel_notice' => [
		'title' => 'Laravel Ecosystem 🚀',
		'line_one' => 'Zestex is built on top of Laravel :laravel_version. <a href="https://www.laravel.com" target="_blank" class="text-brand-900">Learn more</a>',
