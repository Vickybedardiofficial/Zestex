...
return Application::configure(basePath: dirname(__DIR__))->withRouting(
        ...
        using: function() {
            ...
            Route::middleware(['web', 'restrict.ip', 'auth', 'user.status', \App\Http\Middleware\EnsureBusinessAccountMiddleware::class, 'device.identifier', 'terminator'])->prefix('business')->group(base_path('routes/business.php'));
